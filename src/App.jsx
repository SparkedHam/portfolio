        ...
        <div className="font-sans bg-gray-900 text-gray-100">
            ...
            >
                ...
                <div className="text-center z-10">
                    ...
                    <p className="text-lg mt-4">Driven Systems Administrator & Software Engineer</p>
                </div>
            </section>

            {/* Skills Section */}
            <section id="skills" className="p-32 bg-gradient-to-r from-gray-800 via-gray-900 to-gray-800">
            ...
            {/* Work Section */}
            <section id="work" className="p-32 bg-gradient-to-tl from-gray-900 to-gray-800">
                <h2 className="text-4xl font-bold mb-8 text-center">Work History</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div
                        className="transform transition duration-500 hover:scale-105 bg-gray-700 p-6 rounded-lg shadow-md animate-fade-in"
                    >
            ...
            {/* Education Section */}
            <section id="education" className="p-32 bg-gradient-to-br from-gray-800 via-gray-700 to-gray-900">
